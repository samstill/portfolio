...
Either remove \`${h}\` to let \`${t}\` handle the selected tab internally or remove \`defaultIndex\` to handle it yourself.`);return v}function xe(e){let s=0;return Y(e,t=>{B(t)&&s++}),s}const Ue=["children","className","disabledTabClassName","domRef","focus","forceRenderTabPanel","onSelect","selectedIndex","selectedTabClassName","selectedTabPanelClassName","environment","disableUpDownKeys","disableLeftRightKeys"];function We(e,s){if(e==null)return{};var t={};for(var i in e)if({}.hasOwnProperty.call(e,i)){if(s.includes(i))continue;t[i]=e[i]}return t}function me(e){return e&&"getAttribute"in e}function ue(e){return me(e)&&e.getAttribute("data-rttab")}function N(e){return me(e)&&e.getAttribute("aria-disabled")==="true"}let G;function Ke(e){const s=e||(typeof window<"u"?window:void 0);try{G=!!(typeof s<"u"&&s.document&&s.document.activeElement)}catch{G=!1}}const Be={className:"react-tabs",focus:!1},Je={children:he},Ye=e=>{fe.checkPropTypes(Je,e,"prop","UncontrolledTabs");let s=f.useRef([]),t=f.useRef([]);const i=f.useRef();function g(n,l){if(n<0||n>=x())return;const{onSelect:y,selectedIndex:R}=e;y(n,R,l)}function p(n){const l=x();for(let y=n+1;y<l;y++)if(!N($(y)))return y;for(let y=0;y<n;y++)if(!N($(y)))return y;return n}function h(n){let l=n;for(;l--;)if(!N($(l)))return l;for(l=x();l-- >n;)if(!N($(l)))return l;return n}function v(){const n=x();for(let l=0;l<n;l++)if(!N($(l)))return l;return null}function I(){let n=x();for(;n--;)if(!N($(n)))return n;return null}function x(){const{children:n}=e;return xe(n)}function $(n){return s.current[`tabs-${n}`]}function z(){let n=0;const{children:l,disabledTabClassName:y,focus:R,forceRenderTabPanel:k,selectedIndex:F,selectedTabClassName:o,selectedTabPanelClassName:u,environment:d}=e;t.current=t.current||[];let c=t.current.length-x();const T=f.useId();for(;c++<0;)t.current.push(`${T}${t.current.length}`);return oe(l,m=>{let S=m;if(V(m)){let b=0,H=!1;G==null&&Ke(d);const U=d||(typeof window<"u"?window:void 0);G&&U&&(H=ne.Children.toArray(m.props.children).filter(B).some((W,C)=>U.document.activeElement===$(C))),S=f.cloneElement(m,{children:oe(m.props.children,W=>{const C=`tabs-${b}`,L=F===b,Z={tabRef:be=>{s.current[C]=be},id:t.current[b],selected:L,focus:L&&(R||H)};return o&&(Z.selectedClassName=o),y&&(Z.disabledClassName=y),b++,f.cloneElement(W,Z)})})}else if(X(m)){const b={id:t.current[n],selected:F===n};k&&(b.forceRender=k),u&&(b.selectedClassName=u),n++,S=f.cloneElement(m,b)}return S})}function P(n){const{direction:l,disableUpDownKeys:y,disableLeftRightKeys:R}=e;if(j(n.target)){let{selectedIndex:k}=e,F=!1,o=!1;(n.code==="Space"||n.keyCode===32||n.code==="Enter"||n.keyCode===13)&&(F=!0,o=!1,E(n)),!R&&(n.keyCode===37||n.code==="ArrowLeft")||!y&&(n.keyCode===38||n.code==="ArrowUp")?(l==="rtl"?k=p(k):k=h(k),F=!0,o=!0):!R&&(n.keyCode===39||n.code==="ArrowRight")||!y&&(n.keyCode===40||n.code==="ArrowDown")?(l==="rtl"?k=h(k):k=p(k),F=!0,o=!0):n.keyCode===35||n.code==="End"?(k=I(),F=!0,o=!0):(n.keyCode===36||n.code==="Home")&&(k=v(),F=!0,o=!0),F&&n.preventDefault(),o&&g(k,n)}}function E(n){let l=n.target;do if(j(l)){if(N(l))return;const y=[].slice.call(l.parentNode.children).filter(ue).indexOf(l);g(y,n);return}while((l=l.parentNode)!=null)}function j(n){if(!ue(n))return!1;let l=n.parentElement;do{if(l===i.current)return!0;if(l.getAttribute("data-rttabs"))break;l=l.parentElement}while(l);return!1}const D=Object.assign({},Be,e),{className:A,domRef:M}=D,O=We(D,Ue);return ne.createElement("div",Object.assign({},O,{className:ze(A),onClick:E,onKeyDown:P,ref:n=>{i.current=n,M&&M(n)},"data-rttabs":!0}),z())},Ge=["children","defaultFocus","defaultIndex","focusTabOnClick","onSelect"];function Ve(e,s){if(e==null)return{};var t={};for(var i in e)if({}.hasOwnProperty.call(e,i)){if(s.includes(i))continue;t[i]=e[i]}return t}const Xe=0,J=1,Ze={children:he,onSelect:qe,selectedIndex:He},Qe={defaultFocus:!1,focusTabOnClick:!0,forceRenderTabPanel:!1,selectedIndex:null,defaultIndex:null,environment:null,disableUpDownKeys:!1,disableLeftRightKeys:!1},et=e=>e.selectedIndex===null?J:Xe,ge=e=>{fe.checkPropTypes(Ze,e,"prop","Tabs");const s=Object.assign({},Qe,e),{children:t,defaultFocus:i,defaultIndex:g,focusTabOnClick:p,onSelect:h}=s,v=Ve(s,Ge),[I,x]=f.useState(i),[$]=f.useState(et(v)),[z,P]=f.useState($===J?g||0:null);if(f.useEffect(()=>{x(!1)},[]),$===J){const D=xe(t);f.useEffect(()=>{if(z!=null){const A=Math.max(0,D-1);P(Math.min(z,A))}},[D])}const E=(D,A,M)=>{typeof h=="function"&&h(D,A,M)===!1||(p&&x(!0),$===J&&P(D))};let j=Object.assign({},e,v);return j.focus=I,j.onSelect=E,z!=null&&(j.selectedIndex=z),delete j.defaultFocus,delete j.defaultIndex,delete j.focusTabOnClick,ne.createElement(Ye,j,t)};ge.tabsRole="Tabs";const tt=a.div`
  min-height: 100vh;
  padding: 40px 20px;
...
All changes have been applied to the form. Feel free to review and make any additional adjustments!`:"No changes were needed. The event details already match your request.");E(b=>[...b,{type:"ai",content:S,timestamp:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}])}catch(c){console.error("Error parsing AI response:",c),E(T=>[...T,{type:"ai",content:"I apologize, but I encountered an error processing the update. Please try rephrasing your request.",timestamp:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}])}}catch(d){console.error("Chat error:",d),E(c=>[...c,{type:"ai",content:d instanceof Error?d.message:"Sorry, I encountered an error processing your request.",timestamp:new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"})}])}finally{x(!1)}},F=(o,u)=>r.jsxs(Ct,{$type:o.type,children:[r.jsx(St,{$type:o.type,dangerouslySetInnerHTML:{__html:o.type==="user"?o.content:re(o.content)}}),o.type!=="info"&&o.timestamp&&r.jsx(jt,{$type:o.type,children:o.timestamp})]},u);return r.jsx(tt,{children:r.jsxs(rt,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.5},children:[r.jsxs(nt,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{delay:.2},children:[r.jsxs(it,{children:[r.jsx(se,{size:24}),"Create New Event"]}),r.jsxs(at,{onSubmit:M,children:[g&&r.jsxs(dt,{children:[r.jsx($e,{size:16}),g]}),r.jsxs(_,{children:[r.jsxs(q,{htmlFor:"title",children:[r.jsx(ke,{size:16}),"Event Title"]}),r.jsx(K,{type:"text",id:"title",name:"title",value:t.title,onChange:O,placeholder:"Enter event title",required:!0})]}),r.jsxs(_,{children:[r.jsxs(q,{htmlFor:"date",children:[r.jsx(se,{size:16}),"Date & Time"]}),r.jsx(K,{type:"datetime-local",id:"date",name:"date",value:t.date,onChange:O,required:!0})]}),r.jsxs(_,{children:[r.jsxs(q,{htmlFor:"location",children:[r.jsx(je,{size:16}),"Location"]}),r.jsx(K,{type:"text",id:"location",name:"location",value:t.location,onChange:O,placeholder:"Enter event location",required:!0})]}),r.jsxs(ct,{children:[r.jsxs(_,{children:[r.jsxs(q,{children:[r.jsx(Oe,{size:16}),"Price"]}),r.jsx(lt,{type:"number",name:"price",value:t.price,onChange:O,placeholder:"0.00",min:"0",step:"any",required:!0})]}),r.jsxs(_,{children:[r.jsxs(q,{children:[r.jsx(Se,{size:16}),"Total Tickets"]}),r.jsx(K,{type:"number",name:"totalTickets",value:t.totalTickets,onChange:O,placeholder:"100",min:"1",required:!0})]})]}),r.jsxs(_,{children:[r.jsxs(q,{htmlFor:"description",children:[r.jsx(Ce,{size:16}),"Description",r.jsx("span",{children:"(Markdown supported)"})]}),r.jsx(ft,{children:r.jsx(ht,{id:"description",name:"description",value:t.description,onChange:O,placeholder:"Write your event description here..."})})]}),r.jsxs(st,{children:[r.jsxs(pt,{type:"submit",whileHover:{scale:1.02},whileTap:{scale:.98},children:[r.jsx(Ee,{size:18}),"Save Event"]}),r.jsxs(ut,{type:"button",onClick:()=>e("/events"),whileHover:{scale:1.02},whileTap:{scale:.98},children:[r.jsx(Ie,{size:18}),"Cancel"]})]})]}),r.jsxs(mt,{children:[r.jsxs(gt,{children:[r.jsx(Pe,{size:20}),"Preview"]}),r.jsx(xt,{children:r.jsx(Ae,{children:t.description})})]})]}),r.jsx(ot,{children:r.jsxs(bt,{children:[r.jsx(Re,{children:$&&r.jsx(Tt,{initial:{opacity:0,height:0},animate:{opacity:1,height:"auto"},exit:{opacity:0,height:0},transition:{duration:.3},children:r.jsxs($t,{children:[r.jsx(kt,{ref:A,children:P.map((o,u)=>F(o,u))}),r.jsxs(Et,{children:[r.jsx(It,{placeholder:"Type your message...",value:j,onChange:o=>D(o.target.value),onKeyDown:o=>{o.key==="Enter"&&!o.shiftKey&&j.trim()&&(o.preventDefault(),k())}}),r.jsx(ae,{onClick:k,disabled:!j.trim()||I,whileHover:{scale:1.05},whileTap:{scale:.95},children:I?r.jsx(w.div,{animate:{rotate:360},transition:{duration:1,repeat:1/0,ease:"linear"},children:r.jsx(le,{size:18})}):r.jsx(De,{size:18})})]})]})})}),r.jsxs(yt,{$isVisible:!$,children:[r.jsx(wt,{placeholder:"Ask AI to help create your event...",value:h,onChange:o=>v(o.target.value),onKeyDown:o=>{o.key==="Enter"&&!o.shiftKey&&h.trim()&&(o.preventDefault(),R())}}),r.jsx(vt,{onClick:R,disabled:!h.trim()||I,children:I?r.jsx(w.div,{animate:{rotate:360},transition:{duration:1,repeat:1/0,ease:"linear"},children:r.jsx(le,{size:18})}):r.jsx(Fe,{size:18})})]})]})})]})})};export{Ot as default};
