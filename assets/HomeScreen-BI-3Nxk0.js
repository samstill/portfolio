...
`,ws=({isVisible:e})=>{const[t,i]=m.useState(!1),{currentUser:n}=Zt();return m.useEffect(()=>{const s=r=>{const o=r.target;!o.closest("#nav-links")&&!o.closest("#menu-button")&&i(!1)};return document.addEventListener("click",s),()=>document.removeEventListener("click",s)},[]),f.jsx(vs,{$isVisible:e,children:f.jsxs(ys,{children:[f.jsx(xs,{id:"menu-button",onClick:()=>i(!t),children:t?f.jsx(Vi,{}):f.jsx(zi,{})}),f.jsxs(bs,{id:"nav-links",$isOpen:t,children:[n&&f.jsxs(f.Fragment,{children:[f.jsx(Pe,{to:"/events",children:"Events"}),f.jsx(Pe,{to:"/tickets",children:"Tickets"})]}),!n&&f.jsxs(f.Fragment,{children:[f.jsxs(Pe,{to:"/login",children:[f.jsx(et,{size:18}),"Sign In"]}),f.jsxs(Pe,{to:"/signup",children:[f.jsx(et,{size:18}),"Sign Up"]})]})]})]})})},_s=Fi`
  html {
...
`,Qs=()=>{gs("Home");const{currentUser:e}=Zt(),t=m.useRef(null),[i,n]=m.useState(!1),s=m.useRef(null),[r,o]=m.useState(!1),[c,d]=m.useState(!1),[a,v]=m.useState(""),[h,p]=m.useState(!1),[l,g]=m.useState(!1),[y,w]=m.useState(0);m.useEffect(()=>{d(!0),(()=>{window.pageYOffset>window.innerHeight*.5&&n(!0)})()},[]),m.useEffect(()=>{const b={root:null,rootMargin:"-10% 0px -10% 0px",threshold:[.1,.5]},k=new IntersectionObserver(A=>{A.forEach(j=>{j.isIntersecting?n(!0):j.boundingClientRect.top>0&&n(!1)})},b);return s.current&&k.observe(s.current),()=>{s.current&&k.unobserve(s.current)}},[c]),m.useEffect(()=>{let b=0;const k=()=>{const A=window.pageYOffset;o(A>100&&A>b),b=A,w(window.scrollY)};return window.addEventListener("scroll",k,{passive:!0}),()=>window.removeEventListener("scroll",k)},[]);const S=async b=>{if(b.preventDefault(),!!a.trim()){p(!0);try{await Hi.createMessage(a),v(""),g(!0),setTimeout(()=>g(!1),3e3)}catch(k){console.error("Failed to send message:",k)}finally{p(!1)}}},_=()=>{var b;(b=t.current)==null||b.scrollTo(1)};return f.jsxs(f.Fragment,{children:[f.jsx(_s,{}),f.jsx(ms,{}),f.jsx(ws,{isVisible:r}),f.jsxs(Ss,{children:[f.jsxs(us,{ref:t,pages:2,style:{top:"0",left:"0"},config:{tension:170,friction:26},children:[f.jsx(Ke,{offset:0,speed:.5,style:{display:"flex",alignItems:"center",justifyContent:"center",pointerEvents:"none"}}),f.jsx(Ke,{offset:0,speed:.1,children:f.jsxs(ks,{children:[f.jsx(Is,{children:"Hi! Welcome to Harshit Padha"}),f.jsx(Ps,{children:"Discover and manage amazing events all in one place. Join our community and start exploring today!"}),f.jsx(As,{$isNavVisible:r,children:e?f.jsxs(Je,{to:"/events",children:[f.jsx(Mi,{size:20}),"View Events"]}):f.jsxs(f.Fragment,{children:[f.jsxs(Je,{to:"/login",children:[f.jsx(et,{size:20}),"Sign In"]}),f.jsxs(Je,{to:"/signup",children:[f.jsx($i,{size:20}),"Sign Up"]})]})})]})}),f.jsxs(Ke,{offset:1,speed:.2,style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[f.jsx(Cs,{ref:s,$isVisible:i,children:f.jsxs(Es,{children:[f.jsx(Ts,{children:"Send an Anonymous Message"}),f.jsxs(Fs,{onSubmit:S,$isSubmitting:h,children:[f.jsx(Os,{placeholder:"Type your message here... Surprise me!",required:!0,value:a,onChange:b=>v(b.target.value),disabled:h}),f.jsxs(Vs,{type:"submit",disabled:h,children:[f.jsx(Ni,{size:20}),h?"Sending...":"Send Message"]})]}),f.jsx(Bi,{children:l&&f.jsxs(zs,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},exit:{opacity:0,y:-10},transition:{duration:.3,ease:"easeOut"},children:[f.jsx(Li,{size:20}),"Message sent successfully!"]})})]})}),f.jsxs(Ms,{children:[f.jsxs(Ae,{to:"/legal/terms-conditions",children:[f.jsx(Ui,{size:16}),"Terms"]}),f.jsxs(Ae,{to:"/legal/privacy-policy",children:[f.jsx(qi,{size:16}),"Privacy"]}),f.jsxs(Ae,{to:"/legal/refund-policy",children:[f.jsx(Yi,{size:16}),"Refunds"]}),f.jsxs(Ae,{to:"/legal/about-us",children:[f.jsx(Qi,{size:16}),"About Us"]})]})]})]}),f.jsx(Rs,{$scrollY:y,children:f.jsxs(js,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{type:"spring",stiffness:260,damping:20,delay:1},whileHover:{scale:1.05},whileTap:{scale:.95},onClick:_,children:[f.jsx("p",{children:"Scroll to send anonymous message"}),f.jsx(Me.div,{animate:{y:[0,6,0],scale:[1,1.1,1]},transition:{repeat:1/0,duration:2,ease:"easeInOut",times:[0,.5,1]},children:f.jsx(Di,{size:22})})]})})]})]})};export{Qs as default};
